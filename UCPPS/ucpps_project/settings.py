"""
Django settings for ucpps_project project.
...
SECRET_KEY = ')e1arzjjy-buk16d-$4vmtmbj%8k_+u1&^4rlersj7-$a4134('
...
ROOT_URLCONF = 'ucpps_project.urls'
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'ucpps_project.wsgi.application'
